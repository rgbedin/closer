...
Page {
    ...
    signal businessCardEditorClose()
    titleBar: TitleBar {
        id: addBar
        title: "Update"
        ...
        acceptAction: ActionItem {
            ...
            onTriggered: {
                ...
                //Field -> new / Others -> Old
                _closer.updateSelectedRecord(companyField.text, nameField.text, corporateTitleField.text, emailField.text, phoneField.text, addressArea.text, aboutMeArea.text, "", company, name, corporateTitle, email, phone, address, aboutMe, "");
                //                cardCreator.businessCardEditorClose();
            }
        }
    } // TitleBar
    Container {
